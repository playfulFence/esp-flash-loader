...
MEMORY {
    /* Start 16 bytes into SRAM: 8-byte header sits at 0x2F000008, EBREAK at 0x2F000008,
       so PC-4 = 0x2F000004 remains inside SRAM (avoids "Error using system bus" on semihosting check) */
    IRAM   : ORIGIN = 0x2F000010, LENGTH = 0x10000
    /* Data/BSS/stack after the code region */
    RWDATA : ORIGIN = 0x2F010000, LENGTH = 0x50000
}
 ...
 *
 *
 * Generated from ./target/esp32s31/interface-esp32s31.yml md5sum 0cb775308c66eebf0757e406021ad5be
 *
...
PROVIDE( Cache_WriteBack_Invalidate_All = 0x2f800604 );
